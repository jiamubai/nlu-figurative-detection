'''
FL_pooler.py file with f1 score
Haven't run yet
'''
...
#             scheduler.step()
        ...
        val_acc, loss, f1 = evaluate(model, val_data)
        print("Validation acc: {:.3f}, cross entropy loss: {:.3f}, f1 score: {:.3f}".format(val_acc, loss, f1))
